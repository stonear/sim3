<div class="row clearfix">
	...
	<div class="col-sm-9 col-xs-12">
		<div class="card">
			...
			<div class="body">
				<form class="form-horizontal" autocomplete="off" role="form" action="<?php echo base_url(); ?>Admin/update_mahasiswa/<?php echo $mahasiswa[0]->nrp ?>" method="post">
					<div class="row clearfix">
						...
						<div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
							<div class="form-group">
								<div class="form-line">
									<input type="number" id="nrp" name="nrp" class="form-control" placeholder="masukkan nrp" value="<?php echo $mahasiswa[0]->nrp ?>" required>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row clearfix">
						...
						<div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
							<div class="form-group">
								<div class="form-line">
									<input type="text" id="panggilan" name="panggilan" class="form-control" placeholder="masukkan nama panggilan" value="<?php echo $mahasiswa[0]->panggilan ?>">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row clearfix">
						...
						<div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
							<div class="form-group">
								<div class="form-line">
									<input type="text" id="tempat" name="tempat" class="form-control" placeholder="masukkan tempat lahir" value="<?php echo explode(', ', $mahasiswa[0]->ttl, 2)[0] ?>">
								</div>
							</div>
						</div>
					</div>
					<div class="row clearfix">
						...
						<div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
							<div class="form-group">
								<div class="form-line">
									<input type="text" id="tanggal" name="tanggal" class="datepicker form-control" placeholder="masukkan tanggal lahir"  value="<?php echo explode(', ', $mahasiswa[0]->ttl, 2)[1] ?>">
								</div>
							</div>
						</div>
					</div>
					<div class="row clearfix">
						...
						<div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
							<div class="form-group">
								<div class="form-line">
									<input type="text" id="no" name="no" class="form-control" placeholder="masukkan no. telp" pattern="[0-9]+" value="<?php echo $mahasiswa[0]->no ?>">
								</div>
							</div>
						</div>
					</div>
					<div class="row clearfix">
						...
						<div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
							<div class="form-group">
								<div class="form-line">
									<input type="email" id="email" name="email" class="form-control" placeholder="masukkan email" value="<?php echo $mahasiswa[0]->email ?>">
								</div>
							</div>
						</div>
					</div>
					<div class="row clearfix">
						...
						<div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
							<div class="form-group">
								<div class="form-line">
									<textarea rows="3" id="asal" name="asal" class="form-control no-resize auto-growth" placeholder="Masukkan alamat asal"><?php echo $mahasiswa[0]->asal ?></textarea>
								</div>
							</div>
						</div>
					</div>
					<div class="row clearfix">
						...
						<div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
							<div class="form-group">
								<div class="form-line">
									<textarea rows="3" id="kos" name="kos" class="form-control no-resize auto-growth" placeholder="Masukkan alamat sekarang"><?php echo $mahasiswa[0]->kos ?></textarea>
								</div>
							</div>
						</div>
					</div>
					<div class="row clearfix">
						...
						<div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
							<div class="form-group">
								<div class="form-line">
									<input type="text" id="pesantren" name="pesantren" class="form-control" placeholder="masukkan nama pesantren"  value="<?php echo $mahasiswa[0]->pesantren ?>">
								</div>
							</div>
						</div>
					</div>
					<div class="row clearfix">
						...
						<div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
							<div class="form-group">
								<div class="form-line">
									<textarea rows="3" id="alamatpesantren" name="alamatpesantren" class="form-control no-resize auto-growth" placeholder="Masukkan alamat pesantren"><?php echo $mahasiswa[0]->alamatpesantren ?></textarea>
								</div>
							</div>
						</div>
					</div>
					<div class="row clearfix">
						...
						<div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
							<div class="form-group">
								<div class="form-line">
									<input type="text" id="tk" name="tk" class="form-control" placeholder="masukkan nama TK/RA" value="<?php echo $mahasiswa[0]->tk ?>">
								</div>
							</div>
						</div>
					</div>
					<div class="row clearfix">
						...
						<div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
							<div class="form-group">
								<div class="form-line">
									<input type="text" id="sd" name="sd" class="form-control" placeholder="masukkan nama SD/MI" value="<?php echo $mahasiswa[0]->sd ?>">
								</div>
							</div>
						</div>
					</div>
					<div class="row clearfix">
						...
						<div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
							<div class="form-group">
								<div class="form-line">
									<input type="text" id="smp" name="smp" class="form-control" placeholder="masukkan nama SMP/MTs" value="<?php echo $mahasiswa[0]->smp ?>">
								</div>
							</div>
						</div>
					</div>
					<div class="row clearfix">
						...
						<div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
							<div class="form-group">
								<div class="form-line">
									<input type="text" id="sma" name="sma" class="form-control" placeholder="masukkan nama SMA/MA" value="<?php echo $mahasiswa[0]->sma ?>">
								</div>
							</div>
						</div>
					</div>
					<div class="row clearfix">
						...
						<div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
							<div class="form-group">
								<div class="form-line">
									<input type="text" id="ayah" name="ayah" class="form-control" placeholder="masukkan nama ayah" value="<?php echo $mahasiswa[0]->ayah ?>">
								</div>
							</div>
						</div>
					</div>
					<div class="row clearfix">
						...
						<div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
							<div class="form-group">
								<div class="form-line">
									<input type="text" id="ibu" name="ibu" class="form-control" placeholder="masukkan nama ibu" value="<?php echo $mahasiswa[0]->ibu ?>">
								</div>
							</div>
						</div>
					</div>
...
<div class="modal fade" id="foto" tabindex="-1" role="dialog">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<form action="<?php echo base_url(); ?>Admin/upload_foto/<?php echo $mahasiswa[0]->nrp ?>" method="post" enctype="multipart/form-data">
